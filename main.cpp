...
int main()
{
    ...
    while (true)
    {
        ...
        switch (Select)
        {
            case 1: queryContact(peopleBook);   break;
            case 2: addContact(peopleBook);     break;
            case 3: modifyContact(peopleBook);  break;
            case 4: deleteContact(peopleBook);  break;
            case 5: displayContact(peopleBook); break;
            default: break;
        }
        if (Select == 6)
            break;
...
void modifyContact(PeopleBook & pB)
{
    ...
    else
    {
        ...
        switch (Choice)
        {
            case 1: pN->people.setName(modifyInfo); break;
            case 2: pN->people.setTele(modifyInfo); break;
            case 3: pN->people.setAddr(modifyInfo); break;
            case 4: pN->people.setMail(modifyInfo); break;
            case 5: pN->people.setUnit(modifyInfo); break;
            case 6: pN->people.setComm(modifyInfo); break;
            default: break;
        }
    }
}
